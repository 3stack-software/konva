...
var Shape = (function (_super) {
    ...
    function Shape(config) {
        ...
        var colorId;
        while (true) {
            colorId = Util_1.Util.getRandom24bit();
            if (!exports.shapes.has(colorId)) {
                break;
            }
        }
        _this.colorId = colorId;
        _this.colorKey = Util_1.Util._24bitToHex(colorId);
        exports.shapes.set(colorId, _this);
    ...
    Shape.prototype.destroy = function () {
        ...
        exports.shapes.delete(this.colorId);
        this.colorId = null;
        this.colorKey = null;
        return this;
    };
...
Factory_1.Factory.addGetterSetter(Shape, 'miterLimit');
