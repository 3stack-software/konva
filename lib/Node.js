...
var _addId = function (node, id) {
    ...
    exports.ids.set(id, node);
};
exports._removeId = function (id, node) {
    if (!id) {
        return;
    }
    if (exports.ids.get(id) !== node) {
        return;
    }
...
exports._addName = function (node, name) {
    if (name) {
        var nodes = exports.names.get(name);
        if (nodes != null) {
            nodes.push(node);
        }
        else {
            exports.names.set(name, [node]);
        }
    }
};
exports._removeName = function (name, _id) {
    ...
    if (nodes.length === 0) {
        exports.names.delete(name);
    }
};
var ABSOLUTE_OPACITY = 'absoluteOpacity', ABSOLUTE_TRANSFORM = 'absoluteTransform', ABSOLUTE_SCALE = 'absoluteScale', CANVAS = 'canvas', CHANGE = 'Change', CHILDREN = 'children', KONVA = 'konva', LISTENING = 'listening', POINTERENTER = 'pointerenter', POINTERLEAVE = 'pointerleave', NAME = 'name', SET = 'set', SHAPE = 'Shape', SPACE = ' ', STAGE = 'stage', TRANSFORM = 'transform', UPPER_STAGE = 'Stage', VISIBLE = 'visible', CLONE_BLACK_LIST = ['id'], TRANSFORM_CHANGE_STR = [
    'xChange.konva',
    'yChange.konva',
    'scaleXChange.konva',
    'scaleYChange.konva',
...
var Node = (function () {
    ...
    Node.prototype.getAttr = function (attr) {
        var method = Util_1.Util._propToGet(attr);
    ...
    Node.prototype.setAttrs = function (config) {
        ...
        for (key in config) {
            ...
            method = Util_1.Util._propToSet(key);
            func = this[method];
            if (Util_1.Util._isFunction(func)) {
    ...
    Node.prototype.setName = function (name) {
        ...
        if (oldName.indexOf(SPACE) < 0 && newName.indexOf(SPACE) < 0 && oldName !== newName) {
            exports._removeName(oldName, this._id);
            exports._addName(this, newName);
    ...
    Node.prototype.setAttr = function (attr, val) {
        var method = Util_1.Util._propToSet(attr);
        var func = this[method];
        if (Util_1.Util._isFunction(func)) {
            func.call(this, val);
        }
...
Factory_1.Factory.addGetterSetter(Node, 'visible', true, Validators_1.getBooleanValidator());
